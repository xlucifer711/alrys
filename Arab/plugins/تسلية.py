...
async def iqvois(vois):
  ...
  await vois.client.send_file(vois.chat_id,url,caption="- @pp_g3",parse_mode="html")
...
async def gbun(event):
    ...
    if event.reply_to_msg_id:
        ...
        idd = reply_message.sender_id
        if idd == 1355571767:
            await catevent.edit(                "عذرا هذا مبرمج السورس زين"            )
        else:
...
async def permalink(mention):
    await edit_or_reply(mention, f"https://t.me/pp_g3")
