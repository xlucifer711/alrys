...
async def on_plug_in_callback_query_handler(event):
    ...
    buttons = [
        (Button.inline(text="هتساله سوال.", data="to_enquire_something"),),
        (Button.inline(text="عاوزه في مصلحه😂 .", data="to_request_something"),),
        (Button.inline(text="تتكلم معاه👀 .", data="to_chat_with_my_master"),),
        (Button.inline(text="ترخم علي الـمـالـڪ😈 .", data="to_spam_my_master_inbox"),),
    ]
...
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**🝳 ⦙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
    text = "**⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈\n\n🝳 ⦙ ابـعـتـ سـوألـڪ و سـتـنـي لـمـا المـالڪ يـفـتـﺣـ🌪\n🝳 ⦙ هـيـࢪد علـيـڪ🧑‍🦯🧑‍🦯\n\n⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈♥️🧸**"
...
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**🝳 ⦙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
    text = "**⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈\n\n🝳 ⦙  اسـتـنـي لـمـا المـالـڪـ يـفـتـحـ وقـلـو الـمـصـلـحـهہ‌‏\n🝳 ⦙ هـيـࢪد علـيـڪ\n\n⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈**"
...
async def on_plug_in_callback_query_handler(event):
    if event.query.user_id == event.client.uid:
        text = "**🝳 ⦙   عـذرا ، هـذه الـخـيـارات لـلـمـسـتـخـدم الـذي يـراسـلـك 🧸♥️**"
        return await event.answer(text, cache_time=0, alert=True)
    text = "**⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈\n🝳 ⦙ الـمالڪ مـش فـاضـي حـالـيا للـڪلام\n🝳 ⦙ هـيـࢪد علـيـڪ\n⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈️**"
...
async def on_plug_in_callback_query_handler(event):
    ...
    text = "**"`\n(\_/)`"
                     ...
                     "`\n(\_/)`"
                     "`\n(•_•)`"
                     "`\n🌹<\ *` **\n\n **⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈\n🝳 ⦙ يـخـلصـ شغـل و يـجي تـࢪخـمـو عـلـي بـعـضـ انـا بـوت غـلـبان\n🝳 ⦙ هـيـࢪد علـيـڪ\n⎈━━━⊶𐂡•𝘾𝙍☥𝙎𝙊𝙐𝙍𝘾𝙀•𐂡⊷━━━⎈**"
