...
async def fetch_info(replied_user, event):
    ...
    rotbat = "⌁ من اصحاب السورس 𓄂𓆃 ⌁" if user_id == 627658332 or user_id == 1050898456 or user_id == 1355571767 or user_id == 5092041118 else ("⌁ عضو عادي 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 627658332 and user_id != 1050898456 and user_id != 1355571767 and user_id != 1355571767  else rotbat
    ...
    caption += f"ٴ{iqthonF} "
    caption += f" ᑕ.ᖇ ՏOᑌᖇᑕ𝖤  - @c_r_source"    
