...
plugin_category = "@c_r_source "
LOGS = logging.getLogger(__name__)
iqthon_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "╮•⎚ مـعلومات الـشخص مـن بـوت كرستين"
iqthonM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "•❃"
iqthonF = gvarstatus("CUSTOM_ALIVE_FONT") or "ᚖ⌁⌁⌁⌁⌁⌁⌁⌁⧼c.ʀ ѕᴏᴜʀᴄᴇ⧽⌁⌁⌁⌁⌁⌁⌁⌁ᚖ"
...
async def fetch_info(replied_user, event):
    ...
    user_bio = "لاتـوجـد نبـذة" if not user_bio else user_bio
        rotbat = "⌁ من مطورين السورس 𓄂𓆃 ⌁" if user_id == 1355571767 or user_id == 1050898456 or user_id == 1001132193 or user_id == 5092041118 or user_id == 627658332  else ("⌁ العضـو 𓅫 ⌁")
    rotbat = "⌁ مـالك الحساب 𓀫 ⌁" if user_id == (await event.client.get_me()).id and user_id != 627658332 and user_id != 1050898456 and user_id != 1355571767 and user_id != 5092041118 and user_id != 1001132193  else rotbat
