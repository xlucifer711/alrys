...
async def fetch_info(replied_user, event):
    ...
    user_bio = "لاتـوجـد نبـذة" if not user_bio else user_bio
        rotbat = "「من مطـورين السورس 𓄂𓆃」" if user_id == 1050898456 or user_id == 1355571767 or user_id == 5092041118 or user_id == 1001132193 or user_id == 627658332 else (".「  العضـو 𓅫  」.") 
